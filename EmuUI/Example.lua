local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Jeikaru/Wonderhoy/main/EmuUI/Source.lua", true))()


local Legit = library:AddWindow('Main')
local Rage = library:AddWindow('Wonderhoy')
local Anti-Aim = library:AddWindow('SHUT THE FUCK UP')
local watermark = library:AddWatermark('GO KILL YOURSELF');
